...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(62, 38);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(62, 106);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(62, 171);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(62, 236);
			...
			this->ClientSize = System::Drawing::Size(282, 338);
